# OpenEval operating reference

[Start with the README](../README.md) for installation and the product tour.
...
- **Cached collection:** fingerprint validation and shared parsing reduce repeated work; live polling avoids resending unchanged transcript payloads. Performance depends on the source files and machine.
