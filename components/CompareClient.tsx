    ...
    <div className="p-8 max-w-7xl mx-auto">
      ...
      {a && b && a !== b && summaryA && summaryB && (
        <section className="stagger-grid grid grid-cols-2 md:grid-cols-4 gap-3 mb-4">
          ...
          <Delta label="Total cost" a={`${summaryA.estimatedCostCases ? "~" : ""}$${summaryA.totalCostUsd.toFixed(4)}`} b={`${summaryB.estimatedCostCases ? "~" : ""}$${summaryB.totalCostUsd.toFixed(4)}`} aVal={summaryA.totalCostUsd} bVal={summaryB.totalCostUsd} lowerIsBetter />
