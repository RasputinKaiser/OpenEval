...
const LiveTraceSchema = z
  .object({
    ...
    format: z.enum(["claude-projects", "codex-sessions", "jsonl-dir", "hermes-json", "hermes-sqlite", "agent-sqlite", "kimi-wire", "deepseek-jsonl", "grok-markdown"]).default("jsonl-dir"),
